...
internal class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        else if (_command == Command.GenerateEnum)
        {
            ...
            GenerateEnum(enumNamesInput, enumValuesInput, _filePath, enumName);
        }
        else if (_command == Command.GenerateUnorderedList)
        {
            ...
            ConvertListToHtmlFile(listInput, _filePath);
        }
        ...
        else if (_command == Command.GenerateFieldDescriptions)
        {
            ...
            if (tikTokCategories.IsSuccess && tikTokCategories?.Data?.CategoryList != null)
            {
                ...
                foreach (var productAttribute in _attributes)
                {
                    if (Constants.REQUIREDFIELDS.Contains(productAttribute.Name))
                    {
    ...
    public static void ConvertObjectToHtmlDescriptionFile(CategoryDescriptions description, string filePath)
    {
